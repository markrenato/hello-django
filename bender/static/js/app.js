...
var app = new Framework7({
  ...
  routes: [
    ...
    },
    {
        ...
        url: 'pages/aniversariantes.html',
    },
    {
        path: '/historico-peso/',
        url: 'pages/historico-peso.html',
    },
    {
        path: '/contas-a-pagar/',
        url: 'pages/contas-a-pagar.html',
    },
    {
        path: '/historico-abastecimento/',
        url: 'pages/historico-abastecimento.html',
    },
    {
        path: '/noticia/:intNoticiaId',
        url: 'http://192.168.0.10:8080/jarvis-web/NoticiaAction.posConsultar.mtw?intNoticiaId={{intNoticiaId}}',
    }
  ]
});
...
//Infinite Scroll on Historico Peso (Mark)
$$(document).on('page:init', '.page[data-name="historico-peso"]', function (e) {
  var allowInfinite = true;
  $$('#pages-infinite-scroll').on('infinite', function () {
    // Exit, if loading in progress
    if (!allowInfinite) return;
